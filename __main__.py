...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Repo", "https://github.com/huanglinh/chipmirror")
    buttons.buildbutton("Report Group", "https://t.me/+UQNpArb5QLo0MDA1")
...
def restart(update, context):
    restart_message = sendMessage("Đang Khởi Động...", context.bot, update.message)
    if Interval:
        Interval[0].cancel()
    alive.kill()
...
def main():
    ...
    if ospath.isfile(".restartmsg"):
        ...
        bot.edit_message_text("Đã Khởi Động Lại Bot!", chat_id, msg_id)
        osremove(".restartmsg")
